...
\newboolean{kom} %Deklaration
\setboolean{kom}{false} %Zuweisung
...
\ifthenelse{\boolean{kom}}{
    \newcommand{\komGutachter}{Erstgutachter: Prof. Dr.-Ing. Ralf Steinmetz\xspace}
    \newcommand{\komBetreuer}{Zweitgutachter: Prof. Dr. David Hausheer\xspace}
    \newcommand{\komExternerBetreuer}{Betreuer: Christian Groﬂ, M.Sc.\xspace}
    \newcommand{\komID}{KOM-type-number\xspace}

}{
    \newcommand{\komGutachter}{Erstgutachter: Prof. Dr. David Hausheer\xspace}
    \newcommand{\komBetreuer}{Zweitgutachter: Prof. Dr.-Ing. Ralf Steinmetz\xspace}
    \newcommand{\komExternerBetreuer}{Betreuer: Christian Gro\ss, M.Sc.\xspace}
    \newcommand{\komID}{PS-type-number\xspace}
}
...
\ifthenelse{\boolean{kom}}{
    ...
    \subsubtitle{\komName \\ \komID}
    %\setinstitutionlogo[height]{kom_info}
    \institution{\raggedleft Fachbereich Elektrotechnik \\und Informationstechnik\\[\baselineskip]%
	    Fachgebiet Peer-to-Peer \\ Systems Engineering\\%(PS)
...
\lowertitleback{%
	Technische Universit‰t Darmstadt \\%
	Fachbereich Elektrotechnik und Informationstechnik\\[\baselineskip]%
	Fachgebiet Peer-to-Peer Systems Engineering (PS)\\%
	Prof. Dr. David Hausheer%
	%Department of Electrical Engineering and Information Technology \\%
	%Department of Computer Science (Adjunct Professor) \\[\baselineskip]%
